...
| <a name="input_aks_subnet_name"></a> [aks\_subnet\_name](#input\_aks\_subnet\_name) | ACR/AKS subnet name, needed when private\_acr\_enabled is true or private\_cluster\_enabled is true | `string` | n/a | yes |
| <a name="input_aks_vnet_name"></a> [aks\_vnet\_name](#input\_aks\_vnet\_name) | ACR/AKS vnet name, needed when private\_acr\_enabled is true or private\_cluster\_enabled is true | `string` | n/a | yes |
| <a name="input_aks_vnet_rg_name"></a> [aks\_vnet\_rg\_name](#input\_aks\_vnet\_rg\_name) | Name of the acr/aks vnet, needed when private\_acr\_enabled is true or private\_cluster\_enabled is true | `string` | n/a | yes |
